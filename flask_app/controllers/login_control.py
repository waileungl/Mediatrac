...
def profile():
    if 'id' not in session:
        return redirect('/')
    user_id = session["id"]
    return render_template('index.html',ten_watching_shows = Shows.get_ten_lastest_shows("Watching", user_id), ten_to_watch_shows = Shows.get_ten_lastest_shows("Want", user_id))
